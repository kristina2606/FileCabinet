...
namespace FileCabinetApp.Serializers.Models.Xml
{
    /// <summary>
    ...
    public class FileCabinetRecordSeralization
    {
        ...
        {
            get { return this.DateOfBirth.ToString(DateTimeConstants.EUDateFormat, CultureInfo.InvariantCulture); }
            set => this.DateOfBirth = DateTime.ParseExact(value, DateTimeConstants.EUDateFormat, CultureInfo.InvariantCulture, DateTimeStyles.None);
        }
